...
RequiredAssemblies = @('.\Assembly\Asmodat Standard SSH.NET.dll',
...
FormatsToProcess = @('Format\SSHSession.Format.ps1xml',
...
FileList = @('Posh-SSH.psm1','Assembly\Asmodat Standard SSH.NET.dll', 'Assembly\Newtonsoft.Json.dll')
